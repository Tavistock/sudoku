...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20501 = (0);while(true){
var m_20502 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20502 == null))
{} else
{m_20502.call(null);
if((count_20501 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20503 = (count_20501 + (1));
count_20501 = G__20503;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__9081__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__9081__auto__)
