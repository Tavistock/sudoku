...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t20507 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t20507 = (function (val,box,meta20508){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t20507.cljs$lang$type = true;
cljs.core.async.impl.channels.t20507.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t20507";
cljs.core.async.impl.channels.t20507.cljs$lang$ctorPrWriter = (function (this__9670__auto__,writer__9671__auto__,opt__9672__auto__){return cljs.core._write.call(null,writer__9671__auto__,"cljs.core.async.impl.channels/t20507");
});
cljs.core.async.impl.channels.t20507.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t20507.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20509){var self__ = this;
var _20509__$1 = this;return self__.meta20508;
});
cljs.core.async.impl.channels.t20507.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20509,meta20508__$1){var self__ = this;
var _20509__$1 = this;return (new cljs.core.async.impl.channels.t20507(self__.val,self__.box,meta20508__$1));
});
cljs.core.async.impl.channels.__GT_t20507 = (function __GT_t20507(val__$1,box__$1,meta20508){return (new cljs.core.async.impl.channels.t20507(val__$1,box__$1,meta20508));
});
}
return (new cljs.core.async.impl.channels.t20507(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__9673__auto__,writer__9674__auto__,opts__9675__auto__){return cljs.core._write.call(null,writer__9674__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__9670__auto__,writer__9671__auto__,opt__9672__auto__){return cljs.core._write.call(null,writer__9671__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_20510 = self__.takes.pop();if((taker_20510 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_20510))
{var take_cb_20511 = cljs.core.async.impl.protocols.commit.call(null,taker_20510);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_20511,taker_20510,this$__$1){
return (function (){return take_cb_20511.call(null,null);
});})(take_cb_20511,taker_20510,this$__$1))
);
} else
{}
{
